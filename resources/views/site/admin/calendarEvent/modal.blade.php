    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="font-family: kanit;">
            <div class="modal-header text-white bg-primary">
                <h5 class="modal-title" id="exampleModalLabel"><i class="far fa-calendar-alt mr-2"></i> Event</h5>
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <?= Form::text('name', null, ['class' => 'form-control mb-3', 'placeholder' => 'Name Event', 'autocomplete'=> 'off','maxlength' =>'100','pattern' =>'^[ก-๏\sa-zA-Z]+$' ,'required']); ?>
...
<div class="modal fade" id="showEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="font-family: kanit;">
            ...
            <div class="modal-body">
                <?= Form::open(array('route' => 'calendarEvent.update')) ?>
                <div class="form-group">
                    <div class="form-group">
                        <?= Form::label('name-edit', '* Event : '); ?>
                        <?= Form::text('name-edit', null, ['class' => 'form-control', 'placeholder' => 'Name Event', 'autocomplete'=> 'off','maxlength' =>'100','pattern' =>'^[ก-๏\sa-zA-Z]+$' ,'required']); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i> Close</button>       
                <button type="submit" class="btn btn-success text-white"><i class="fas fa-sign-in-alt"></i> Confirm</button>
            </div>
            <?= Form::close() ?>
        </div>
    </div>
